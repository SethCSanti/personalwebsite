...
import {
  SiReact, SiMongodb, SiHtml5, SiCss, SiJavascript, SiPython
} from "react-icons/si"
import { TbApi } from "react-icons/tb"
import { FiPackage, FiCode, FiCpu, FiBook } from "react-icons/fi"
...
function ProjectCard({ title, description, link, tech = [], icon, wip = false, status }) {
  return (
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "10px", flexWrap: "wrap" }}>
        ...
        {(wip || status === "planning") && (
          <span style={{
            ...
            background: status === "planning"
              ? "rgba(107,184,176,0.15)"
              : "rgba(217,125,38,0.15)",

            border: status === "planning"
              ? "1px solid rgba(107,184,176,0.4)"
              : "1px solid rgba(217,125,38,0.4)",
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "7px", marginBottom: "20px" }}>
          {tech.map((t) => (
            <span key={t} style={{
              ...
              padding: "3px 10px",
              borderRadius: "999px",
              background: "rgba(107,184,176,0.08)",
              border: "1px solid rgba(107,184,176,0.25)",
      ...
      <section style={{ padding: "72px 0" }}>
        <div className="container">
          ...
          <div style={{
            ...
            <ProjectCard
              title="AI Assistant"
              icon={<FiCpu style={{ color: "var(--storm-teal)" }} />}
              description="An AI-powered assistant application. Details and repository coming soon."
              link={null}
              tech={["Python", "API"]}
              status="planning"
            />
            ...
            <ProjectCard
              ...
              icon={<FiBook style={{ color: "var(--storm-teal)" }} />}
              description="A robotics project designed to serve as a study companion. Combining hardware and software to create an interactive learning experience."
              link={null}
              tech={["Python"]}
              status="planning"
            />
